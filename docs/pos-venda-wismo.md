...
Migration: [`202609200004_wismo_logistics_sla.sql`](../supabase/migrations/202609200004_wismo_logistics_sla.sql). Todas as tabelas com RLS habilitada e sem policies — só `service_role` acessa, pelo padrão já usado no resto do projeto.
